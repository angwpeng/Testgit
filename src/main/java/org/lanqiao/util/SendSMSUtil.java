...
public class SendSMSUtil {
    ...
    // 替换成你的AK
    private static final String accessKeyId = "LTAI5tJp7UfuXShJD2tu8yTe";// 你的accessKeyId
    private static final String accessKeySecret = "SmE49N4fAtkGa9lXDkkFmiMHu5gfws";// 你的accessKeySecret
    private static final String signName = "wpblog";// 签名
    private static final String templateCode = "SMS_463895237";// 短信模板
